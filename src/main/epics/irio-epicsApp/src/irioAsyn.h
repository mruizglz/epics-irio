 ...
 */
static platform_profile_t platform_profile[6] = { { flexRIO_DAQ,
		"flexRIO DMA Data Acquisition profile." }, { flexRIO_IMAQ,
		"flexRIO IMAQ Data Acquisition profile." }, { flexRIO_DAQ_GPU,
		"flexRIO GPU DMA Data Acquisition profile." }, { flexRIO_IMAGE_GPU,
		"flexRIO GPU IMAGE Data Acquisition profile." }, { cRIO_DAQ,
		"cRIO DMA Data Acquisition profile." }, { cRIO_IO,
		"cRIO Point by Point Data Acquisition profile." }, };
/**
...
public:
	...
	virtual asynStatus writeOctet(asynUser *pasynUser, const char *value,
			size_t maxChars, size_t *nActual); 	//!< Asyn asynOctet interface
