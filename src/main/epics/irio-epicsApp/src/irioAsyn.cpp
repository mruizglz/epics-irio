...
//
 irio::irio(const char *namePort, const char *DevSerial,
		...
		const char *FPGAversion, int verbosity): asynPortDriver(
				namePort,
				1,
				asynOctetMask | asynInt32Mask | asynInt32ArrayMask | asynFloat64Mask | asynFloat32ArrayMask |asynEnumMask | asynDrvUserMask, // interface mask,
				asynOctetMask | asynInt32Mask | asynInt32ArrayMask | asynFloat64Mask | asynFloat32ArrayMask |asynEnumMask , // interrupt mask,
				0,
				1,
				0,
